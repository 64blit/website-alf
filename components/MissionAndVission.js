        ...
        <section className='pt-[3rem]'>
            ...
            <div className="container mission flex flex-col md:grid md:grid-cols-[50%_48%] gap-6 items-center">
                <div className="text flex flex-col items-center md:items-start text-center md:text-left">
                    ...
                    <p className='leading-[2rem]'>At American Language Fund, our mission is to promote linguistic and cultural diversity by investing in dying languages, film, and school infrastructure of communities and cultures on the brink of extinction. We believe that linguistic and cultural diversity diversity are essential to the preservation of the biosphere and ethnosphere.</p>
