        ...
        <div>
            ...
            <section className="2 container mission flex flex-col md:grid md:grid-cols-[48%_50%] gap-6 items-center py-[3rem]">
                ...
                <div className="text flex flex-col items-center md:items-start text-center md:text-left">
                    <h2 className='font-bold text-2xl mb-[3rem]'>Tincidunt etiam tincidunt integer</h2>
            ...
            <section className="3 bg-slate-200 py-[3rem]">
                ...
                <div className="container flex flex-wrap md:grid md:grid-cols-3 gap-4">
                    <div className="border border-slate-300 bg-white flex flex-col gap-4 p-12 py-14">
                        <Image src={Vector} className="w-[4rem]" alt="Vector chart"/>
                        {/* <h2 className="text-2xl font-bold">Lorem Ipsum</h2> */}
                        <p className="mt-[2rem]">The number of Native American Language speakers in North America has increase 17% due to language revitalization programs.</p>
                    </div>
                    <div className="border border-slate-300 bg-white flex flex-col gap-4 p-12 py-14">
                        <Image src={Vector} className="w-[4rem]" alt="Vector chart"/>
                        {/* <h2 className="text-2xl font-bold">Lorem Ipsum</h2> */}
                        <p className="mt-[2rem]">63% of indigenous languages are still in use despiste being endangered.</p>
                    </div>
                    <div className="border border-slate-300 bg-white flex flex-col gap-4 p-12 py-14">
                        <Image src={Vector} className="w-[4rem]" alt="Vector chart"/>
                        {/* <h2 className="text-2xl font-bold">Lorem Ipsum</h2> */}
                        <p className="mt-[2rem]">50% of all documented languages online have an online presence.</p>
                    </div>
                </div>
            </section>
            {/* -------------------------------------------------------------------------------------- */}
