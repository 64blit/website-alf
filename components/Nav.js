...
const Nav = () =>
{
    ...
    return (
        <nav className="flex justify-center md:justify-between  items-center min-w-100 pt-[1rem] md:pt-[3rem] px-[1rem] md:px-[1rem] lg:px-[6rem] xl:px-[12rem] lg:gap-[3rem] ">
            ...
            {/* navLinks */}
            <div className="nav-links hidden sm:gap-[2rem] shrink flex-initial md:flex">
                <Link href="/" className="transition duration-200 hover:scale-125">
            ...
            {/* cta */}
            <div className="cta flex gap-3 items-center min-w-[14rem] max-w-[14rem] md:mx-[2rem] sm:max-w-[1rem]">
